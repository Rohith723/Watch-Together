      ...
      >
        ...
        <form className="flex flex-col gap-6" onSubmit={handleLogin}>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            type="submit"
            className="p-3 bg-blue-500 hover:bg-blue-600 rounded transition duration-300"
          >
            Login
          </motion.button>
        </form>

        <p className="mt-4 text-center cursor-pointer hover:underline" onClick={() => navigate("/signup")}>
